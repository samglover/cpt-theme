...
?>
		...
		<footer id="footer" class="site-footer">
			<ul id="footer-widgets" class="footer-widgets wp-block-group is-layout-flex">
			...
			<div class="footer-meta wp-block-group has-global-padding is-layout-constrained">
				<div class="wp-block-group is-layout-flex is-content-justification-space-between">
					<p class="copyright">The original content within this website is &copy; <?php echo esc_html( gmdate( 'Y' ) ); ?>.</p>
					<p class="developer">
						<a href="https://samglover.net">Website design and development by Sam Glover.</a>
					</p>
				</div>
			</div>
		</footer>
	...
	<?php if ( 'modal' === get_option( 'cpt_sites_primary_menu_cta_style' ) ) { ?>
