...
### Fixed
- Remove placeholder URL from search form
- Align search form layout
...
Steps to add a font in your child theme:
  ...
  3. Copy `settings.typography.fontFamilies` and `styles.typography.fontFamily` from the parent `theme.json` to the child theme's `theme.json`
