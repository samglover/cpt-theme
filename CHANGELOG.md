...
### Changed
- Moved the script that adds a :root variable for the header height to /assets/js/header-height.js so it can be used for other things (like padding cover blocks so they stay out of the way of the header).
